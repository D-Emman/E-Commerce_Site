...
function getproducts(){
    ...
    <a href='index.php?addCart=$product_id' class='btn btn-info'>Add to Cart</a>
...
function view_details(){
   ...
   <div class='row'>
      <div class='col-md-12'>
         <h4 class='text-center text-info mb-5'>More on Products</h4> 
      </div>
      <div class='col-md-6'>
        ...
        if(!isset($_GET['my_orders'])){
            if(!isset($_GET['delete_account'])){
             ...
             if($row_count>0){
              ...
              <p class='text-center  mb-5'><a href='profile.php?my_orders' class='text-success' >Order Details</a></p>";
             }
             else{
                echo "<h3 class='text-center text-success my-5'>You have zero orders</h3>
                <p class='text-center  mb-5'><a href='../index.php' class='text-success' >Explore products</a></p>";
               }
            }
        }
       }
